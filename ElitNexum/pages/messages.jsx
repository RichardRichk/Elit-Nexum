...
const MessagesPage = ({ user }) => {
  ...
  return (
    <div className="bg-gray-50 container mx-auto h-chat">
      <div className="bg-white border border-whiteelit rounded flex h-full">
        <div
          className={`${chat ? 'hidden md:block' : 'block'
            } w-full sm:w-1/2 md:w-1/3 lg:w-1/4 h-full overflow-y-auto`}
        >
          <div className="border-b border-whiteelit p-3 relative">
            <button className="flex items-center font-inconsolata mx-auto select-none font-semibold focus:outline-none">
              Conversas do {user.name}
            </button>
          </div>
        ...
        <div
          className={`${chat ? 'flex w-full' : 'hidden md:flex'
            } md:w-2/3 lg:w-3/4 border-l border-whiteelit items-center justify-center text-center`}
        >
          {banner.name && banner.profilePicUrl ? (
            ...
            <div className="space-y-5">
              <div className="border border-deepviolet rounded-full inline-flex p-5 items-center justify-center">
                <ChatAltIcon className="h-20 w-20 text-deepviolet" />
              </div>
              <div className="space-y-0.5">
                <h1 className="font-semibold text-xl font-inconsolata">Converse com desenvolvedores!</h1>
                <p className="text-deepgrayelit min-w-46 font-inconsolata">
                  Selecione ou busque um usuário para começar a conversar.
                </p>
              </div>
            </div>
          )}
