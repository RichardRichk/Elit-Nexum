  ...
  return (
    <div className="relative">
      <input
        ...
        className="w-full bg-gray-100 p-2 border-0 border-b border-gray-200 focus:ring-0 font-inconsolata focus:border-deepviolet"
        value={searchText}
          ...
          {data.length > 0 ? (
            data.map((user) => (
              ...
              >
                ...
                />
                <p className="text-md ml-2 font-inconsolata">
                  {user.name.length > 20
            ...
            <p className='font-inconsolata'>Nenhum usuário encontrado...</p>
          )}
        </div>
      )}
    </div>
