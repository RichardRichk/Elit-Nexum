            ...
            >
              <div className="inline-block align-bottom bg-white rounded text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg w-3/4">
                <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                  <div className="sm:flex sm:items-center border-b border-gray-200 pb-2">
                    ...
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      <Dialog.Title
                        as="h3"
                        className="text-lg font-inconsolata leading-6 font-bold text-blackelit"
                      >
                        Curtidas
                      </Dialog.Title>
                    </div>
                ...
                <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                  <button
                    type="button"
                    className="mt-3 w-full inline-flex justify-center rounded border border-grayelit shadow-sm px-4 py-2 bg-white text-base font-bold text-blackelit hover:bg-gray-50 focus:outline-none focus:ring-1 focus:ring-offset-2 focus:ring-deepviolet sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"
                    onClick={() => setOpen(false)}
                    ref={cancelButtonRef}
                  >
                    Fechar
